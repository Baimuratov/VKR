...
<body>
    ...
    <div style="height: 559px; width: 1210px;" class="auto-style1">
        ...
        <asp:Label ID="Label8" runat="server" style="z-index: 1; left: 572px; top: 103px; position: absolute" Text="Icbo ="></asp:Label>
        ...
        <asp:Label ID="Label10" runat="server" style="z-index: 1; left: 572px; top: 140px; position: absolute" Text="Tc ="></asp:Label>
        ...
        <asp:TextBox ID="IccTextBox" runat="server" Height="15px" style="z-index: 1; left: 394px; top: 54px; position: absolute; margin-top: 11px" Width="50px"></asp:TextBox>
        ...
        <asp:Label ID="Label1" runat="server" style="z-index: 1; left: 572px; top: 66px; position: absolute" Text="hFE ="></asp:Label>
        ...
        <asp:TextBox ID="TcTypTextBox" runat="server" Height="15px" style="z-index: 1; left: 732px; top: 140px; position: absolute" Width="50px"></asp:TextBox>
        ...
        <asp:Label ID="Label17" runat="server" style="z-index: 1; left: 541px; top: 271px; position: absolute" Text="dhFE/dT = "></asp:Label>
        <asp:Label ID="Label18" runat="server" style="z-index: 1; left: 683px; top: 272px; position: absolute" Text="%/C‪‪"></asp:Label>
        <asp:Label ID="Label19" runat="server" style="z-index: 1; left: 540px; top: 305px; position: absolute" Text="dVbe/dT = "></asp:Label>
        <asp:Label ID="Label20" runat="server" style="z-index: 1; left: 683px; top: 306px; position: absolute" Text="mV/C"></asp:Label>
        <asp:Label ID="Label21" runat="server" style="z-index: 1; left: 499px; top: 341px; position: absolute" Text="dIcbo/dT factor = "></asp:Label>
        <asp:Label ID="Label22" runat="server" style="z-index: 1; left: 683px; top: 342px; position: absolute" Text="/10C"></asp:Label>
        <br />
        <br />
        <br />
        <br />
        ...
        <br />
        <asp:Label ID="Label23" runat="server" Text="Ток коллектора, Ic (mA)"></asp:Label>
        <br />
        ...
        <asp:Label ID="Label15" runat="server" style="z-index: 1; left: 565px; top: 236px; position: absolute" Text="VBE = "></asp:Label>
        <asp:Table ID="STable" runat="server" GridLines="Both" style="z-index: 1; left: 443px; top: 439px; position: absolute; height: 25px; width: 434px">
            <asp:TableRow ID="Head" runat="server" BackColor="#EEEEF2" BorderWidth="1px" HorizontalAlign="Center" VerticalAlign="Middle">
                ...
                <asp:TableCell runat="server">Изменение Ic (mA); typ hFE, Tc</asp:TableCell>
            </asp:TableRow>
            <asp:TableRow ID="Icbo" runat="server" HorizontalAlign="Center" VerticalAlign="Middle">
                <asp:TableCell runat="server" BackColor="#EEEEF2">Icbo</asp:TableCell>
                <asp:TableCell runat="server"></asp:TableCell>
                <asp:TableCell runat="server"></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow ID="Vbe" runat="server" HorizontalAlign="Center" VerticalAlign="Middle">
                <asp:TableCell runat="server" BackColor="#EEEEF2">Vbe</asp:TableCell>
                <asp:TableCell runat="server"></asp:TableCell>
                <asp:TableCell runat="server"></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow ID="hFE" runat="server" HorizontalAlign="Center" VerticalAlign="Middle">
                <asp:TableCell runat="server" BackColor="#EEEEF2">hFE</asp:TableCell>
                <asp:TableCell runat="server"></asp:TableCell>
                <asp:TableCell runat="server"></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow ID="DeltaIcTotal" runat="server" HorizontalAlign="Center" VerticalAlign="Middle">
                <asp:TableCell runat="server" BackColor="#EEEEF2"></asp:TableCell>
                <asp:TableCell runat="server" BackColor="Silver">Изменение Ic, общее = </asp:TableCell>
                <asp:TableCell runat="server"></asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        </div> 
