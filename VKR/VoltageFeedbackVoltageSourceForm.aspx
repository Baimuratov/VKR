<%@ Page Title="Схема с фиксированным напряжением база-эмиттер" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VoltageFeedbackVoltageSourceForm.aspx.cs" Inherits="VKR.VoltageFeedbackVoltageSourceForm" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div style="height: 798px;" class="auto-style1">
        <h2>Схема с фиксированным напряжением база-эмиттер</h2>
            <br />
        <div style="height: 327px; width: 567px; position: absolute;">
            <img src="Resources/V-FB%20V-Source.png" style="z-index: -4; left: 0px; top: 28px; position: absolute" /><asp:TextBox ID="Rb1TextBox" runat="server" Height="15px" style="z-index: 1; left: 72px; top: 98px; position: absolute" Width="70px" ReadOnly="True"></asp:TextBox>
            <asp:Label ID="mA1Label" runat="server" style="z-index: 1; left: 530px; top: 64px; position: absolute" Text="мА"></asp:Label>
            <asp:Label ID="V1Label" runat="server" style="z-index: 1; left: 530px; top: 28px; position: absolute" Text="В"></asp:Label>
            <asp:TextBox ID="VccTextBox" runat="server" Height="15px" style="z-index: 1; left: 467px; top: 28px; position: absolute" Width="50px">2,7</asp:TextBox>
            <asp:TextBox ID="IcTextBox" runat="server" Height="15px" style="z-index: 1; left: 283px; top: 100px; position: absolute" Width="50px">5</asp:TextBox>
            <asp:TextBox ID="IccTextBox" runat="server" Height="15px" style="z-index: 1; left: 467px; top: 64px; position: absolute;" Width="50px" ReadOnly="True"></asp:TextBox>
            <asp:TextBox ID="RcTextBox" runat="server" Height="15px" style="z-index: -1; left: 297px; top: 2px; position: absolute" Width="70px" ReadOnly="True"></asp:TextBox>
            <asp:TextBox ID="VceTextBox" runat="server" Height="15px" style="z-index: 1; left: 319px; top: 173px; position: absolute; right: 218px;" Width="50px">2</asp:TextBox>
            <asp:Label ID="mA2Label" runat="server" style="z-index: 1; left: 346px; top: 100px; position: absolute" Text="мА"></asp:Label>
            <asp:Label ID="V2Label" runat="server" style="z-index: 1; left: 383px; top: 173px; position: absolute" Text="В"></asp:Label>
            <asp:Label ID="Ohm1Label" runat="server" style="z-index: 1; left: 383px; top: 2px; position: absolute" Text="Ом"></asp:Label>
            <asp:Label ID="RcLabel" runat="server" style="z-index: 1; left: 262px; top: 2px; position: absolute" Text="R<sub>C</sub> = "></asp:Label>
            <asp:Label ID="VceLabel" runat="server" style="z-index: 1; left: 279px; top: 173px; position: absolute" Text="V<sub>CE</sub> = "></asp:Label>
            <asp:Label ID="IcLabel" runat="server" style="z-index: 1; left: 255px; top: 100px; position: absolute" Text="I<sub>C</sub> = "></asp:Label>
            <asp:Label ID="VccLabel" runat="server" style="z-index: 1; left: 426px; top: 28px; position: absolute; width: 40px;" Text="V<sub>CC</sub> = "></asp:Label>
            <asp:Label ID="IccLabel" runat="server" style="z-index: 1; left: 424px; top: 64px; position: absolute; width: 42px;" Text="I<sub>CC</sub> = "></asp:Label>
            <asp:Label ID="Rb1Label" runat="server" style="z-index: 1; left: 31px; position: absolute; top: 98px;" Text="R<sub>B1</sub> = "></asp:Label>
            <asp:Label ID="Ohm3Label" runat="server" style="z-index: 1; left: 156px; top: 98px; position: absolute" Text="Ом"></asp:Label>
            <asp:TextBox ID="Rb2TextBox" runat="server" Height="15px" style="z-index: 1; left: 72px; top: 244px; position: absolute" Width="70px" ReadOnly="True"></asp:TextBox>
            <asp:Label ID="Rb2Label" runat="server" style="z-index: 1; left: 31px; top: 244px; position: absolute" Text="R<sub>B2</sub> = "></asp:Label>
            <asp:Label ID="Ohm4Label" runat="server" style="z-index: 1; left: 156px; top: 244px; position: absolute" Text="Ом"></asp:Label>
            <asp:Label ID="VbeLabel" runat="server" style="z-index: 1; left: 172px; top: 203px; position: absolute" Text="V<sub>BE</sub>"></asp:Label>
            <asp:Label ID="Irb2Label" runat="server" style="z-index: 1; left: 24px; top: 198px; position: absolute" Text="I<sub>RB2</sub>"></asp:Label>
            <asp:CustomValidator ID="VccValidator" runat="server" ControlToValidate="VccTextBox" style="z-index: 1; left: 545px; position: absolute; top: 25px;" OnServerValidate="VccValidator_ServerValidate" ErrorMessage="Значение V<sub>CC</sub> должно быть числом и лежать в интервале:<br/>0 < V<sub>CC</sub> ≤ 1000" ValidateEmptyText="True"><img src="Resources/Exclamation.png" title="Значение Vcc должно быть числом и лежать в интервале: 0 < Vcc ≤ 1000"/></asp:CustomValidator>
            <asp:CustomValidator ID="IcValidator" runat="server" ControlToValidate="IcTextBox" ErrorMessage="Значение I<sub>C</sub> должно быть числом и лежать в интервале:<br/>0 < I<sub>C</sub> ≤ 5000" OnServerValidate="IcValidator_ServerValidate" style="z-index: 1; left: 373px; top: 97px; position: absolute" ValidateEmptyText="True"><img src="Resources/Exclamation.png" title="Значение Ic должно быть числом и лежать в интервале:0 < Ic ≤ 5000"/></asp:CustomValidator>
            <asp:CustomValidator ID="VceValidator" runat="server" ControlToValidate="VceTextBox" OnServerValidate="VceValidator_ServerValidate" style="z-index: 1; left: 400px; top: 170px; position: absolute" ErrorMessage="Значение V<sub>CE</sub> должно быть числом и лежать в интервале:<br/>0 < V<sub>CE</sub> < V<sub>CC</sub>" ValidateEmptyText="True"><img src="Resources/Exclamation.png" title="Значение Vce должно быть числом и лежать в интервале:0 < Vce < Vcc"/></asp:CustomValidator>
        </div>
