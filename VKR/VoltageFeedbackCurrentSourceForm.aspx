<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VoltageFeedbackCurrentSourceForm.aspx.cs" Inherits="VKR.VoltageFeedbackCurrentSourceForm" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <h2>Смещение с обратным напряжением с источником постоянного тока</h2>
        ...
        <div style="height: 339px">
            ...
            <asp:Label ID="RcLabel" runat="server" style="z-index: 1; left: 318px; top: 93px; position: absolute" Text="R<sub>C</sub> = "></asp:Label>
            <asp:Label ID="RbLabel" runat="server" style="z-index: 1; left: 105px; top: 238px; position: absolute" Text="R<sub>B</sub> = "></asp:Label>
        ...
        <div style="height: 225px; width: 491px; z-index: 1; left: 608px; top: 248px; position: absolute">
        Правила проектирования<br />
            <br />
            <div style="width: 115px; text-align: right; height: 176px;">
...
&nbsp;мА<br />
        ...
        <div style="z-index: 1; left: 10px; top: 516px; position: absolute; height: 174px; width: 227px">
        ...
        <div style="width: 463px; z-index: 1; left: 608px; top: 516px; position: absolute; height: 145px">
