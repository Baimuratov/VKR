    ...
    public partial class VoltageFeedbackCurrentSourceForm : System.Web.UI.Page
    {
        ...
        protected void CalculateButton_Click(object sender, EventArgs e)
        {
            if (IsValid)
            {
                ...
                Vrb2TextBox.Text = scheme.Vrb2.ToString("0.00");
        ...
        protected void a1Validator_ServerValidate(object source, ServerValidateEventArgs args)
        {
            double value;
            try
            {
                ...
                else
                {
                    try
                    {
                        double Vce = Convert.ToDouble(VceTextBox.Text);
                        scheme.Vrb2 = value * Vce;
                    }
                    catch (Exception)
                    {
                        ;
